<div class="px-8 mx-auto max-w-7xl lg:px-16 tails-selected-element" contenteditable="true">
    ...
    <div class="grid grid-cols-1 gap-0 text-gray-600 md:grid-cols-2 md:gap-16">
        <div class="">
            ...
            <p>
                You can upgrade your account by visiting <a href="" class="text-indigo-500 underline" data-primary="indigo-500">The Pro Upgrade Page</a>. You will also gain access to many other applications and sections of the site.
